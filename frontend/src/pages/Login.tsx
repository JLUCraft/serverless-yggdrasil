  ...
  return (
    <div class="min-h-screen w-full flex flex-col lg:flex-row bg-base-100">
      ...
      <div class="hidden lg:flex lg:w-1/2 relative bg-primary/5 flex-col justify-between p-12 border-r border-slate-200">
        ...
        <div class="relative z-10">
          <p class="text-xs text-slate-400">Powered by Yggdrasil</p>
        </div>
      </div>
      ...
      <div class="flex-1 flex items-center justify-center p-6 sm:p-10 animate-fade-in">
        <div class="w-full max-w-sm space-y-6">
          ...
          <div>
            <h2 class="text-2xl font-bold text-slate-800 tracking-tight">登录账号</h2>
            <p class="mt-1 text-sm text-slate-500">请输入您的皮肤站账号信息</p>
          </div>

          <form onSubmit={handleSubmit} class="space-y-4">
            <div class="form-control">
              <label class="label py-1">
                <span class="label-text font-semibold text-slate-700">用户名</span>
              </label>
              <input
                type="text"
            ...
            <div class="form-control">
              <label class="label py-1">
                <span class="label-text font-semibold text-slate-700">密码</span>
              </label>
              <input
                type="password"
                class="input glass-input w-full focus:ring-2 focus:ring-primary/20 focus:outline-none"
          ...
          <div class="relative">
            ...
            <div class="relative flex justify-center">
              <span class="bg-base-200 px-3 text-xs text-slate-400">新用户？</span>
            </div>
          </div>
