  ...
  return (
    <div class="relative flex flex-col items-center justify-center min-h-[85vh] py-16 px-4 overflow-hidden">
      <div class="relative z-10 text-center max-w-4xl w-full animate-fade-in mt-8">
        ...
        <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-br from-slate-900 via-primary to-slate-700 tracking-tighter leading-tight mb-5">
          {siteConfig.appName}
        </h1>

        <p class="text-base md:text-xl text-slate-500 font-light max-w-2xl mx-auto leading-relaxed mb-10 tracking-wide">
